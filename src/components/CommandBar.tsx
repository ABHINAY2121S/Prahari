  ...
  return (
    ...
    >
      <div className="flex items-center gap-3.5">
        ...
        <div style={{ width: 1, height: 28, background: "var(--stroke-hairline)" }} />
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col items-center">
            <span className="label-xs text-[9px]" style={{ color: "var(--text-muted)" }}>T+ ELAPSED</span>
            <span className="font-mono font-bold text-xs" style={{ color: "var(--text-primary)" }}>
              07:42:19
            </span>
          </div>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <div style={{ width: 1, height: 18, background: "var(--stroke-hairline)" }} />
          ...
          {[1, 2, 5].map((spd) => (
            <button
              ...
              style={{
                ...
                color: streamSpeed === spd ? "var(--state-advisory)" : "var(--text-muted)",
        ...
        <button
          ...
          style={{
            background: "var(--bg-raised)",
            border: "1px solid var(--stroke-hairline)",
            color: soundOn ? "var(--state-advisory)" : "var(--text-muted)",
            fontSize: 13,
          }}
